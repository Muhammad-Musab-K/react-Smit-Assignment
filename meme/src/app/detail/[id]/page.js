...
export default function Details({ params }) {
  ...
  return <div className="w-full bg-white">
    ...
    <div className='mb-4'>
      ...
      <input className='text-black h-12 p-2 border border-black rounded' type="text" id="text1" value={text1} onChange={(e) => setText1(e.target.value)} />
    </div>
    <div className='mb-4'>
      <label htmlFor="text2" className='mr-2'>Text 2:</label>
      <input className='text-black h-12 p-2 border border-black rounded' type="text" id="text2" value={text2} onChange={(e) => setText2(e.target.value)} />
    </div>
